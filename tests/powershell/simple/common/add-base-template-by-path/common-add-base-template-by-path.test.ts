...
describe("powershell", () => {
    it("common-add-base-template-by-path", async () => {
        // Arrange
        ...
        // Act
        await callTool(client, "common-add-base-template-by-path", args);
        ...
        // Act
        await callTool(client, "common-remove-base-template-by-path", removeBaseTemplateArgs);
    });
});
