...
describe("powershell", () => {
    it("security-add-rolemember", async () => {
        ...
        const newRoleArgs: Record<string, any> = {
            identity: roleName,
            description: "Test role created for Add-RoleMember test"
        };
        ...
        const newUserArgs: Record<string, any> = {
            ...
            fullName: "Test User",
            comment: "Test user created for Add-RoleMember test"
        };
        ...
        const addRoleMemberResult = await callTool(client, "security-add-rolemember", addRoleMemberArgs);
